package com.higer.oildataexchange.quartz;
...
public class QuartzManager {
    ...
    public void addSimpleTriggerJob(String jobName, Class<? extends Job> cls, Date date, int count, int interval, JobDataMap dataMap) {
        addSimpleTriggerJob(jobName, JOB_GROUP_NAME, jobName, TRIGGER_GROUP_NAME, cls, date, count, interval, dataMap);
    }

    public void addSimpleTriggerJob(String jobName, String jobGroupName, String triggerName, String triggerGroupName, Class<? extends Job> cls, Date date, int count, int interval, JobDataMap dataMap) {
        try {
            ...
            if (count != 0) {
                scheduleBuilder = SimpleScheduleBuilder.simpleSchedule().withMisfireHandlingInstructionFireNow().withIntervalInSeconds(interval).withRepeatCount(count);
            } else {
                scheduleBuilder = SimpleScheduleBuilder.simpleSchedule().withMisfireHandlingInstructionFireNow();
            }
            // 按新的cronExpression表达式构建一个新的trigger
    ...
    public void modifySimpleTriggerJob(String jobName, String jobGroupName, String triggerName, String triggerGroupName, Class<? extends Job> cls, Date date, int count, int interval, JobDataMap dataMap) {
        try {
            removeJob(jobName, jobGroupName, triggerName, triggerGroupName);
            addSimpleTriggerJob(jobName, jobGroupName, triggerName, triggerGroupName, cls, date, count, interval, dataMap);
    ...
    public void modifySimpleTriggerJob(String jobName, Class<? extends Job> cls, Date date, int count, int interval, JobDataMap dataMap) {
        modifySimpleTriggerJob(jobName, JOB_GROUP_NAME, jobName, JOB_GROUP_NAME, cls, date, count, interval, dataMap);
    }
    ...
    public boolean exist(String jobName) {
        return exist(jobName, TRIGGER_GROUP_NAME);
    }
