...
public interface FlightMapper {
    ...
    List<TFlightInfoList> getFlightList(@Param("flgtAirportCode") String flgtAirportCode);
    ...
    //更新航班的任务下发标识
    int updateFlightInfoOne(@Param("taskFlightId") String taskFlightId, @Param("i") int i);
    ...
    MyFlightCode getFLIGHTCODEFind(@Param("arcrRegn") String arcrRegn, @Param("startDate") String startDate);
