...
public interface NewFuelMapper {
     ...
     * @return
     */
    List<MyFuel> findNewFuelsToday(@Param("staffAirportCode") String staffAirportCode, @Param("limit") Integer limit);
     ...
     * @return
     */
    int addNewFuel(@Param("fuel") MyFuel fuel);
     ...
     * @return
     */
    List<MyFuel> findUnusedFuel(@Param("date") Date date);
}
