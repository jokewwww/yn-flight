package com.zhoildataexchange.util;
...
//	}
     ...
     * @return
     */
    public static Boolean compareDateAbs(Date date1 , Date date2) {
        long time = date1.getTime();
        long time1 = date2.getTime();
        int x = Math.abs((int)((time - time1) / 1000 / 60));
        if(x > 60){
            return true;
        }
        return false;
    ...
    // 获取一个小时之前的时间
    public static Date poorDate(Date data){
        Calendar calendar = Calendar.getInstance();
    ...
    public static Integer compareDate(Date data){
        long a = data.getTime();
    ...
    public static boolean isEffectiveDate(Date nowTime) {
        ...
        calendar1.set(Calendar.HOUR_OF_DAY, 4);// 让日期加1
        calendar1.set(Calendar.MINUTE,0);// 让日期加1
        calendar1.set(Calendar.SECOND,0);// 让日期加1
    ...
    public static void main(String[] args) {
        try {
            ...
            String s = "2019-10-21 04:59:59";
            String s1 = "2019-10-22 03:59:59";
            System.out.println(isEffectiveDate(sim1.parse(s)));
            System.out.println(isEffectiveDate(sim1.parse(s1)));
        } catch (ParseException e) {
            e.printStackTrace();
        }
    }
