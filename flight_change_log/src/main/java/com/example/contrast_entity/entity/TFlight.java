...
import com.example.contrast_entity.framework.annotation.ChangeStatus;
import com.example.contrast_entity.framework.annotation.OperationLog;
 ...
 */
@Entity
@Table(name = "T_FLIGHT", schema = "zhoil_flight", catalog = "")
public class TFlight {
    ...
    @OperationLog
    private java.util.Date flgtFlop;//航班日期
    @OperationLog
    ...
    private String flgtLinkFlno;    // 连接航班号（共享航班号1，共享航班号2）
    private Integer flgtLinkRepeat; //  连接航班连接次数
    private java.util.Date flgtLinkFlop;      // 连接航班日期
    ...
    private java.util.Date flgtCrewInPlace;//机组到位时间
    private java.util.Date flgtChocksIn;//上轮档时间
    private java.util.Date flgtChocksOut;//撤轮挡时间
    private java.util.Date flgtFirstLugg;//第一件行李时间
    private java.util.Date flgtLastLugg;//最后一件行李时间
    private java.util.Date flgtPtax;//前飞计划到达时间
    private java.util.Date flgtEtax;//前飞预计到达时间
    private java.util.Date flgtAtax;//前飞实际到达时间
    ...
    // flgt_placecode_status
    private Integer  flgtPlacecodeStatus;

    @Basic
    @Column(name = "flgt_regn_status", nullable = true, length = 1)
    ...
    @Basic
    @Column(name = "flgt_placecode_status", nullable = true, length = 1)
    ...
    @Id
    @Column(name = "flgt_id", nullable = false, length = 40)
    ...
    @Basic
    @Column(name = "flgt_ffid", nullable = true, length = 40)
    ...
    @Basic
    @Column(name = "flgt_aptarea_code", nullable = true, length = 7)
    ...
    @Basic
    @Column(name = "flgt_flno", nullable = true, length = 100)
    ...
    @Basic
    @Column(name = "flgt_flop", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_acname", nullable = true, length = 10)
    ...
    @Basic
    @Column(name = "flgt_regn", nullable = true, length = 10)
    ...
    @Basic
    @Column(name = "flgt_placecode", nullable = true, length = 10)
    ...
    @Basic
    @Column(name = "flgt_al2c", nullable = true, length = 10)
    ...
    @Basic
    @Column(name = "flgt_alcname", nullable = true, length = 40)
    ...
    @Basic
    @Column(name = "flgt_vialc", nullable = true, length = 100)
    ...
    @Basic
    @Column(name = "flgt_a_stot", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_a_etot", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_a_atot", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_d_stot", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_d_etot", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_d_atot", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_org3c", nullable = true, length = 3)
    ...
    @Basic
    @Column(name = "flgt_orgnm", nullable = true, length = 60)
    ...
    @Basic
    @Column(name = "flgt_trs3c1", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "flgt_trsnm1", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "flgt_trs3c2", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "flgt_trsnm2", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "flgt_trs3c3", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "flgt_trsnm3", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "flgt_trs3c4", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "flgt_trsnm4", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "flgt_trs3c5", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "flgt_trsnm5", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "flgt_des3c", nullable = true, length = 3)
    ...
    @Basic
    @Column(name = "flgt_desnm", nullable = true, length = 60)
    ...
    @Basic
    @Column(name = "flgt_adid", nullable = true, length = 1)
    ...
    @Basic
    @Column(name = "flgt_mission_prop", nullable = true, length = 3)
    ...
    @Basic
    @Column(name = "flgt_nature", nullable = true, length = 3)
    ...
    @Basic
    @Column(name = "flgt_sub_nature", nullable = true, length = 1)
    ...
    @Basic
    @Column(name = "flgt_flti", nullable = true, length = 1)
    ...
    @Basic
    @Column(name = "flgt_ftyp", nullable = true, length = 2)
    ...
    @Basic
    @Column(name = "flgt_delaycode", nullable = true, length = 7)
    ...
    @Basic
    @Column(name = "flgt_proxy", nullable = true, length = 3)
    ...
    @Basic
    @Column(name = "flgt_link_flno", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "flgt_link_flop", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_link_repeat", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_repeat", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_fnflag", nullable = true, length = 1)
    ...
    @Basic
    @Column(name = "flgt_ifsr", nullable = true, length = 1)
    ...
    @Basic
    @Column(name = "flgt_game", nullable = true, length = 1)
    ...
    @Basic
    @Column(name = "flgt_dep_runway", nullable = true, length = 4)
    ...
    @Basic
    @Column(name = "flgt_arr_runway", nullable = true, length = 4)
    ...
    @Basic
    @Column(name = "flgt_gate", nullable = true, length = 4)
    ...
    @Basic
    @Column(name = "flgt_crew_in_place", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_chocks_in", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_chocks_out", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_first_lugg", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_last_lugg", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_ptax", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_etax", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_atax", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_takeoff_fuel", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_chock_fuel", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_vip", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_num", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_task_asign", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_starmark", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_manual_flg", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_share_no_flg", nullable = true)
    ...
    @Basic
    @Column(name = "flgt_otc", nullable = true, length = 50)
