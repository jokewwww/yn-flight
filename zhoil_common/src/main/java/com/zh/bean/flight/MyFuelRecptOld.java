 ...
 * T_FUEL_RECPT
 */
public class MyFuelRecptOld implements Serializable {
    /**
     * T_FUEL_RECPT
     */
...
//flrc_operating_type
    private Integer flrcOperatingType;
    ...
    public Integer getFlrcOperatingType() {
        return flrcOperatingType;
    }

    public void setFlrcOperatingType(Integer flrcOperatingType) {
        this.flrcOperatingType = flrcOperatingType;
    }
