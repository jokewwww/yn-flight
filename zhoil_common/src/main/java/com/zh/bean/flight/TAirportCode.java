...
public class TAirportCode implements Serializable {
    ...
    /**
     * 机场属性（D：国内，I：国际，R：地区）
     * @return apcd_airport_prop 机场属性（D：国内，I：国际，R：地区）
     */
    ...
    /**
     * 机场属性（D：国内，I：国际，R：地区）
     * @param apcdAirportProp 机场属性（D：国内，I：国际，R：地区）
     */
    public void setApcdAirportProp(String apcdAirportProp) {
        this.apcdAirportProp = apcdAirportProp == null ? null : apcdAirportProp.trim();
    }
    ...
    /**
     * 中航油内部机场编号
     * @return apcd_cnaf_airport_code 中航油内部机场编号
     */
    ...
    public void setApcdCnafAirportCode(String apcdCnafAirportCode) {
        this.apcdCnafAirportCode = apcdCnafAirportCode == null ? null : apcdCnafAirportCode.trim();
    }

    /**
     * 使用接口协议（01：航二所接口，02：云南接口，03：昆明机场接口，04：新疆机场接口）
     * @return apcd_protocol 使用接口协议（01：航二所接口，02：云南接口，03：昆明机场接口，04：新疆机场接口）
     */
    ...
    /**
     * 使用接口协议（01：航二所接口，02：云南接口，03：昆明机场接口，04：新疆机场接口）
     * @param apcdProtocol 使用接口协议（01：航二所接口，02：云南接口，03：昆明机场接口，04：新疆机场接口）
     */
    public void setApcdProtocol(String apcdProtocol) {
        this.apcdProtocol = apcdProtocol == null ? null : apcdProtocol.trim();
    }
