...
public class ApiLogAspect {
    ...
    public static void main(String[] args) {
        String str = "{\"flrcSign\":\"120020\",\"flightUnit\":\"\",\"flrcSingle\":\"B3801\",\"flrcSingleNew\":\"YN12\",\"flrcAirlCode\":\"HF\"}";
        str = str.replaceAll("\"flrcSign.+?\",\"", "\"")
...
//                request.setFlrcSign(null);
//                request.setFlrcSingle(null);
//                request.setFlrcSingleNew(null);
            }
            ...
            // 油单获取时
            if (obj instanceof TFuelDistribution) {
                TFuelDistribution request = (TFuelDistribution) obj;
