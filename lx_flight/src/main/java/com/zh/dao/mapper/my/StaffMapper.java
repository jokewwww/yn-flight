...
import com.zh.bean.login.MyMessage;
import com.zh.bean.login.MySalesInfo;
...
public interface StaffMapper {
    ...
    //通过人员id查询人员信息（供地图使用）
    MyStaff getStaffById(@Param("staffId") String staffId);
    ...
    //根据车辆编号查询此车是否已经被绑定
    MyStaffVehi getVehiInfo(@Param("sfvhVehiNo") String sfvhVehiNo);

    Integer findMaxLevel(@Param("staffGroupId") String staffGroupId);

    // 根据姓名查询人员信息
    List<MyStaff> findByName(@Param("name") String name);
