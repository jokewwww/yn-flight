...
public interface TaskMapper {
    ...
    //获取当前未分配任务报警的航班
    List<MyNoTaskAlarmFlight> getNoTaskAlarmFlight();

    //PC端根据当前系统时间获取当日的任务列表并且同时根据任务列表中的航班ID查询航班列表一起输出
    List<MyFlightTask> getTaskAndFlight(@Param("staffAirportCode") String staffAirportCode, @Param("staffAptareaCode") String staffAptareaCode, @Param("date") String date, @Param("flgtId") String flgtId);

    // 根据飞机号和航班号获取当前飞机的航班和任务信息
    ...
    //PC端根据当前系统时间获取当日的任务列表并且同时根据任务列表中的航班ID查询航班列表一起输出
    List<MyFlightTask> getTaskAndFlightNew(@Param("staffAirportCode") String staffAirportCode, @Param("staffAptareaCode") String staffAptareaCode, @Param("date") String date);

    //PC端根据当前系统时间获取当日的任务列表并且同时根据任务列表中的航班ID查询航班列表一起输出
    List<MyFlightTask> getTaskAndFlightLock(@Param("staffAirportCode") String staffAirportCode, @Param("staffAptareaCode") String staffAptareaCode, @Param("date") String date, @Param("flgtId") String flgtId);
    ...
    //更新任务客户编码
    int updateTaskCust(@Param("task") MyTask task);

    //更新任务信息
    int updateTaskInfoNew(@Param("task") MyTask task);
    ...
    //根据系统当前日期获取7天的任务列表
    List<MyTask> getTasktSevenDateList(@Param("staffAirportCode") String staffAirportCode, @Param("staffAptareaCode") String staffAptareaCode, @Param("taskDate") String taskDate);
    ...
    //查询当前加油员的当天任务
    List<MyFlightTask> selectTaskByStaffId(@Param("staffId") String staffId, @Param("date") String date);

    MyFlightTask selectTaskByRecptNo(@Param("taskFuelRecptNo") String taskFuelRecptNo);
    ...
    MyTask findByflgtId(@Param("flgtId") String flgtId);
    ...
    int updateTask(@Param("task") MyTask task);

    List<MyFlight> getAFlight(@Param("staffAirportCode") String staffAirportCode, @Param("date") String nowStr);

    List<MyFlight> getAFlightLock(@Param("staffAirportCode") String staffAirportCode, @Param("date") String nowStr);

    List<MyFlight> groupAirportCode();

    int updateTaskCstno(@Param("task") MyTask task);

    List<MyTask> findTasksByflgtId(@Param("flgtId") String flgtId);
