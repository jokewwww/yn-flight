...
public class DateUtil {
    ...
    public static DateFormat dateFormats = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
...
//	}
    ...
    public static Boolean calculateWeek(String strTimes) {
        Calendar calendar = Calendar.getInstance();
        int i = calendar.get(Calendar.DAY_OF_WEEK) - 1;
        if (0 == i) {
            i = 7;
        }
        if (strTimes.contains(String.valueOf(i))) {
            return true;
        }
        return false;
    }
    ...
    public static void main(String[] args) {
        try {
            String s = "1970-01-01 13:31:52";
            Calendar calOld = Calendar.getInstance();
            calOld.setTime(dateFormats.parse(s));
            Calendar cal = Calendar.getInstance();
            ...
            System.out.println(dateFormats.format(time));
